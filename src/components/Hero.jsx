    ...
    <section id="home" className="hero">
      <div className="container hero-container">
        ...
        >
          ...
          >
            <a href="/Ayush_Kumar_AI_Engineer_Resume (1).docx" download className="btn btn-primary">Download Resume</a>
          ...
          <div className="avatar-wrapper">
            <div className="avatar-card glass">
              <div className="avatar-placeholder">
                ...
                <img src="/ChatGPT Image Jul 10, 2026, 02_42_16 AM.png" alt="Ayush Kumar" className="avatar-img" onError={(e) => {
